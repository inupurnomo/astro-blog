import rx from "react-icons/rx/index";
// import {FaRegFolder} from "react-icons/fa";
import pkg from "react-icons/fa/index";
import tb from "react-icons/tb/index";
const { FaRegFolder } = pkg;
// import {TbBrandGithub} from "react-icons/tb";
const { TbBrandGithub } = tb;
const { RxOpenInNewWindow } = rx;
        ...
        {listItem &&
          listItem.map(function (item, i) {
            return (
              <li
                key={i}
                className="cursor-pointer duration-300 hover:text-textPrimary"
              >
                {item}
              </li>
            );
