        ...
        {showMenu && (
          ...
          >
            <motion.div
              ...
              animate={{ x: 0, opacity: 1 }}
              transition={{ duration: 0.1 }}
              className="relative flex h-full w-[80%] flex-col items-center bg-bodyLight px-4 py-10 text-textDark dark:bg-bodyDark dark:text-textLight"
            >
              <MdOutlineClose
              ...
              <div>
                <ul className="flex flex-col gap-7 text-[13px]">
                  ...
                  <a
                    href={"/blog"}
                    className="nav-link flex cursor-pointer items-center justify-center gap-1 font-medium duration-300 hover:text-textPrimary"
                  >
                    <motion.li
                      initial={{ x: 20, opacity: 0 }}
                      animate={{ x: 0, opacity: 1 }}
